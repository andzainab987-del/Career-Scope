...
export const Html = () => {
  const titleWords = 'DISCOVER YOUR FUTURE'.split(' ');
  const subtitle = 'AI-Powered Career Guidance in Technology, Engineering & Aviation';
  ...
  return (
    <div className="h-svh relative overflow-hidden bg-black">
      <div className="h-svh uppercase items-center w-full absolute z-20 pointer-events-none px-6 md:px-10 flex justify-center flex-col text-center">
        <div className="text-3xl md:text-5xl xl:text-6xl 2xl:text-7xl font-extrabold">
          <div className="flex flex-wrap justify-center gap-x-3 md:gap-x-6 text-white tracking-tight">
        ...
        <div className="text-xs md:text-lg xl:text-xl 2xl:text-2xl mt-4 overflow-hidden text-white/70 font-semibold max-w-3xl">
          <div
